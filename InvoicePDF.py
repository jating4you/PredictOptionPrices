...
# Creating Canvas
c = canvas.Canvas("invoice6.pdf",pagesize=(200,250),bottomup=0)
...
c.drawCentredString(125,20,"Sagar Deep PrintHouse")
# For under lining the title
c.line(70,22,180,22)
# Changing the font size for Specifying Address
c.setFont("Helvetica-Bold",5)
c.drawCentredString(125,30,"119- A Shivpuri Geeta Colony,")
c.drawCentredString(125,35,"New Delhi - 110051, India")
...
c.drawString(80,70,"  1")
c.drawRightString(70,80,"DATE :")
c.drawString(80,80,str(date.today()))
c.drawRightString(70,90,"CUSTOMER NAME :")
c.drawString(80,90,'Arora Ji')
c.drawRightString(70,100,"PHONE No. :  ")
c.drawString(80,100,'+ 91 8375076359')
...
c.drawCentredString(75,125,"Tags: 3200 + 2000 =5200")
c.drawCentredString(125,125,"1.00")
c.drawCentredString(173,125,"5200.00")
...
c.drawCentredString(173,210,"5200.00")
